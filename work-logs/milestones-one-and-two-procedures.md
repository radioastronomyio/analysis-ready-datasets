...
2. Decide on repository folder structure
3. Customize templates for this specific project
4. Initialize the memory bank with project context
5. Write interior READMEs for all directories that need them
6. Write the primary README
